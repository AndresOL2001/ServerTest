      ...
      >
        <div className="h-full ml-[23px] mr-[43px] mt-[30px] font-sans overflow-y-auto bg-white">
          <ul className="space-y-2 ">
            ...
            <ListItem
              text="Employees"
              icono={<AccountCircleOutlinedIcon className="mr-3" style={{ color: "#0072B5" }} />}
              iconoAbierto={
                <KeyboardArrowUpIcon className="cursor-pointer mt-2" style={{ color: "#1B3156" }} />
              }
              iconoCerrado={
            ...
            <ListItem
              text="Clients"
              icono={<BusinessIcon className="mr-3" style={{ color: "#0072B5" }} />}
              iconoAbierto={
                <KeyboardArrowUpIcon className="cursor-pointer mt-2" style={{ color: "#1B3156" }} />
              }
              iconoCerrado={
            ...
            <ListItem
              text="Settings"
              icono={<SettingsOutlinedIcon className="mr-3" style={{ color: "#0072B5" }} />}
              iconoAbierto={
                <KeyboardArrowUpIcon className="cursor-pointer mt-2" style={{ color: "#1B3156" }} />
              }
              iconoCerrado={
